...
/*   Updated: 2025/01/18 15:42:48 by rchan-re         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#define C_FIRSTLINE_BEGIN 'o'
#define C_FIRSTLINE_MID '-'
#define C_FIRSTLINE_END 'o'
#define C_INTERMEDIARY '|'
#define C_LASTLINE_BEGIN 'o'
#define C_LASTLINE_MID '-'
#define C_LASTLINE_END 'o'
